...
contract IExerciceSolution is ERC721
{
    ...
    struct Animal {string _name; uint256 _legs; uint256 _sex; bool _wings;}
    struct Parents { uint256 _parent1; uint256 _parent2;}
    struct ReproductionInformations {uint256 price;address authorizedBreeder;bool hasPayed;}
