...
contract Evaluator 
{
	...
	public	
	{
		...
		require(studentExerciceSolution[msg.sender].balanceOf(address(this)) == 1, "err1");
		require(studentExerciceSolution[msg.sender].ownerOf(1) == address(this), "err2");
		...
		require(studentExerciceSolution[msg.sender].balanceOf(address(this)) == 0, "r3");
